...
import { teacherSubjects, teachers, subjects } from '../db/schema'
...
teacherSubjectsRouter.post('/teachers/:teacherId/subjects', zValidator('json', AssignSubjectSchema), async c => {
  try {
    const teacherId = c.req.param('teacherId')
...
teacherSubjectsRouter.post('/teachers/:teacherId/subjects/bulk', zValidator('json', BulkAssignSchema), async c => {
  try {
    const teacherId = c.req.param('teacherId')
