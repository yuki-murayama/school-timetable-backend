...
export const classroomSubjects = sqliteTable('classroom_subjects', {
  ...
  uniqueClassroomSubject: uniqueIndex('unique_classroom_subject').on(table.classroomId, table.subjectId),
}))
...
// 時間割履歴管理
export const timetableHistory = sqliteTable('timetable_history', {
  id: text('id')
    .primaryKey()
    .$defaultFn(() => createId()),
  ...
  timetableVersionIndex: index('timetable_history_version_idx').on(table.timetableId, table.version),
...
export const schedules = sqliteTable('schedules', {
  ...
  originalScheduleId: text('original_schedule_id')
...
// 制約条件設定
export const constraintConfigurations = sqliteTable('constraint_configurations', {
  id: text('id')
    .primaryKey()
    .$defaultFn(() => createId()),
  schoolId: text('school_id')
  ...
  uniqueSchoolConstraint: uniqueIndex('unique_school_constraint').on(table.schoolId, table.constraintType),
